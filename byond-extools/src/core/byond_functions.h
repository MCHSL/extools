...
typedef void(*AppendToContainerPtr)(unsigned char containerType, unsigned int containerValue, unsigned char valueType, unsigned int newValue);
...
typedef void(*IncRefCountPtr)(unsigned int type, unsigned int value);
typedef void(*DecRefCountPtr)(unsigned int type, unsigned int value);
