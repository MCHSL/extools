...
__forceinline std::unique_ptr<Instruction> get_instr(std::uint32_t op) {
	switch (op)
	{
		...
		ADD_CALLBACK(TEST)
		ADD_CALLBACK(LOGICAL_NOT)
		ADD_CALLBACK(JMP)
		ADD_CALLBACK(JUMP_TRUE)
		ADD_CALLBACK(RET)
		...
		ADD_CALLBACK(JMP2)
		ADD_CALLBACK(JUMP_FALSE)
		ADD_CALLBACK(JUMP_FALSE2)
		ADD_CALLBACK(JUMP_TRUE2)
		ADD_CALLBACK(POPN)
		...
		ADD_CALLBACK(BITWISE_AND)
		ADD_CALLBACK(BITWISE_OR)
		ADD_CALLBACK(BITWISE_XOR)
