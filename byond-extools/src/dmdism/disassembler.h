...
public:
	...
	std::vector<unsigned int> disassemble_subvar_follows(Instruction& instr, bool raw_var_access);
	bool disassemble_var(Instruction& instr, bool raw_var_access=false);
